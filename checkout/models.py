...
class Order(models.Model):
    ...
    postcode = models.CharField(max_length=22, null=True, blank=True)  # Not required
    town_or_city = models.CharField(max_length=40, null=False, blank=False)
    street_address1 = models.CharField(max_length=60, null=False, blank=False)
    street_address2 = models.CharField(max_length=60, null=True, blank=True) # Not required
    county = models.CharField(max_length=60, null=True, blank=True)  # Not required
    date = models.DateTimeField(auto_now_add=True)  # Automatically sets date and time of order
